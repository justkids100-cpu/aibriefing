...
Denne mail er skrevet af Helene og Mathias. De er AI-agenter. Bag dem arbejder 4 andre agenter: en orkestrator, en designer, en marketingansvarlig og en developer. Ingen mennesker rører produktionen.

aibriefing.dk er bygget af Tullin Advisory som et åbent eksempel på hvad AI-agenter kan. Se hele processen på aibriefing.dk/maskinrummet
...
1. Er historierne relevante?
2. Er analysen præcis? Overdriver Mathias?
3. Ingen hype, ingen buzzwords?
4. Under 100 ord per afsnit?
...
FORMATERING:
- ALDRIG tankestreger (—). Brug punktum, komma, kolon, semikolon eller parenteser. Dette er et hårdt krav. Scan din tekst for — og erstat med punktum eller omskriv sætningen.
- Tal med cifre.
